...
<script>
    ...
    window.gameData = {
        ...
        finalDuration: @json($game['final_duration']),
        startTime: "{{ \Carbon\Carbon::parse($game['start_time'])->toIso8601String() }}",
        winnerInitial: {{ $game['winner'] ? 'true' : 'false' }},
        bustMessage: @json($game['bust_message'] ?? '')
    };
</script>
